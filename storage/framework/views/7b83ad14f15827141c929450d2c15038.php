...
<div class="card-container">
    <div class="card">
        <a href="<?php echo e(route('jurusan')); ?>" class="card2">Teknik </a>
        <p>Jurusan teknik mempelajari penerapan ilmu sains dan matematika untuk menciptakan solusi teknis.</p>
    </div>
    <div class="card">

        <a href="<?php echo e(route('jurusan')); ?>" class="card2">Kesehatan</a>
    ...
    <div class="card">
        ...
        <a href="<?php echo e(route('jurusan')); ?>" class="card2">Hukum</a>
    ...
    <div class="card">
        <a href="<?php echo e(route('jurusan')); ?>" class="card2">Ekonomi</a>
        <p> Jurusan ekonomi mempelajari produksi, distribusi, dan konsumsi barang dan jasa, serta analisis pasar dan
            kebijakan publik.</p>
    </div>
    <div class="card">
        <a href="<?php echo e(route('jurusan')); ?>" class="card2">Matematika</a>
    ...
    <div class="card">
        <a href="<?php echo e(route('jurusan')); ?>" class="card2">Seni</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\web_majormatch_final\resources\views/informasi.blade.php ENDPATH**/ ?>